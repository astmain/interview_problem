...
const HtmlWebpackPlugin = require('html-webpack-plugin');      //插件html 处理
...
module.exports = {
  ...
  // postcss css兼容性处理：postcss --> postcss-loader postcss-preset-env
  ...
  module: {
    rules: [
      ...
      // eslint 排除 node_modules  不检测 自动修复eslint的错误
      // { test: /\.js$/, exclude: /node_modules/, loader: 'eslint-loader', options: { fix: true } }

      // js兼容问题：指示babel做怎么样的兼容性处理    
      //  npm i babel-loader@8.0.6 -d        "babel-loader": "^8.0.6",      "@babel/preset-env": "^7.8.4",
      //  npm i @babel/preset-env@7.8.4 -d        "babel-loader": "^8.0.6",      "@babel/preset-env": "^7.8.4",
      //  npm i @babel/core@7.8.4 -d        "babel-loader": "^8.0.6",      "@babel/preset-env": "^7.8.4",      "@babel/core": "^7.8.4"
      {
        test: /\.js$/,
  ...
  plugins: [
    ...
    new MiniCssExtractPlugin({ filename: '我的css.css', }),
    // 压缩css
...
npm i eslint-loader@3.0.3   -d
npm i eslint-plugin-import@2.20.1   -d
npm i eslint-config-airbnb-base@14.0.0  -d
