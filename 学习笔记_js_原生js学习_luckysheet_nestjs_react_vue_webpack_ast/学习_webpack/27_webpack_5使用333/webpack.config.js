    ...
    rules: [

      {
        oneOf: [
          ...
          //图片 文件格式   转化
          { test: /\.(png|jpg|svg|gif)$/, type: "asset", generator: { filename: `./assets/[contenthash][ext]` } },
        ],
      },
      //vue 文件格式   转化
...
//inject笔记   https://stackoverflow.com/questions/67439012/chrome-extension-manifest-v3-content-security-policy
//inject笔记   https://javascript.tutorialink.com/chrome-extension-manifest-v3-content-security-policy/

//             https://juejin.cn/post/6996528304685580295
